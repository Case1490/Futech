...
import { db, storage } from "../firebaseConfig"; // Asegúrate de tener configurado Firebase
...
const Search = () => {
  ...
  useEffect(() => {
    // Cargar los datos de las motos desde Firebase
  ...
  useEffect(() => {
    // Filtrar los resultados cuando cambia el término de búsqueda
    if (searchTerm) {
  ...
  const handleSelectResult = () => {
    setSearchTerm(""); // Resetear el input
    setResults([]); // Ocultar los resultados
  };
    ...
    <div className="input-container">
      ...
      {searchTerm && (
        <SearchResults
          ...
          onSelectResult={handleSelectResult} // Pasar función para manejar selección
        />
      )}
    </div>
  );
