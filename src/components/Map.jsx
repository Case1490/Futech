const Map = () => {
  return (
    <div className="w-[80%] m-auto flex flex-col items-center my-10">
      <h1 className="font-bold text-black text-4xl mt-4 mb-8">
      ...
      <div className="flex gap-x-8">
        ...
        <div className="flex flex-col justify-around items-center">
          <p className="text-center text-lg mb-4">
            Visítanos en nuestra tienda física en <span className="font-semibold italic">Villa El Salvador</span>
            , donde encontrarás una amplia variedad de productos. Estamos
            ubicados en una zona accesible, cerca de puntos de referencia como
            el <span className="font-semibold italic">Monumento a la Mujer</span> .
          </p>
